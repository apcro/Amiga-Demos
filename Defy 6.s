...
.high		cmp.w	#232,mouse_y
		...
		move.w	old_mouse,old_mouse2
		move.l	highlight1,highlight2a
...
.clear_it
		movem.l	a0/d1,-(a7)
		move.l	highlight2a,a0
		move.w	old_mouse2,d1
		sub.w	#32,d1		; correction for top panel
		lsr	#3,d1
		lsl	#3,d1
		mulu	#80,d1
		add.w	d1,a0
		cmp.w	#160,old_mousex
		blt.s	.left2
		add.w	#40,a0
.left2
x2 		set 	0
...
blank		dc.l	0,0,0,0,0,0,0,0
		dc.l	0,0,0,0,0,0,0,0
blank2		dc.w	$000,$000,$000,$000,$000,$000,$000,$000
...
.not_font
		...
		lea	text_screen-1,a0	; this screen	was +80
...
y1		set	y1+80
	...
	ifeq	music_on
use		=	$957c&$8009610	;$c00b10f	;$9c38&$9d05
playback_speed	=	3
		include	music/types.i
		include	music/player6.i
		incdir 	work:cdn/defy6/music/
		include	player.s
		incdir	work:cdn/defy6/
	endc
...
text
defylogo	incbin	gfx/defy6.raw.stc	;gfx/defy4-title.raw.stc
	dcb.b	5000
...
articles
		...
		dc.l	a35,a36,a37,a38,a39,a39b,a39a,a40
		dc.l	a41,a42,a43,a44,a45,a46,a47,a48,a49,a50,a51,a52,a53,a54
		dc.l	a55,a56,a57,a58
		dc.l	0,0

		incdir	work:cdn/defy6/art2/
...
aa2		incbin	Disclaimer.stc
		even	
aa3		incbin	contributors2.stc
		even
aa4		incbin	a4000democompat.stc
		even
aa5		incbin	amigairc.stc
		even
aa6		incbin	cdnmakehistory.stc
		even
aa7		incbin	d6-amigauses.stc
		even
a8		incbin	emailoz.stc
		even
a9		incbin	d6-e-mail2.stc
		even
a10		incbin	onetimepad.stc
		even
a11		incbin	raw.stc
		even
a12		incbin	seeingthesites.stc
		even
a13		incbin	scene_quotes.4.stc
		even
a14		incbin	txt.spanishreport3.stc
		even
a15		incbin	d6-dms-banned.stc
		even
a16		incbin	dms-reply.stc
		even	
a17		incbin	censorship.stc
		even
a18		incbin	commercialaintbad.stc
		even
a19		incbin	elitism.stc
		even
a20		incbin	fkthepccrowd-astral.stc	
		even
a21		incbin	letslaughatthem.stc
		even
a22		incbin	thepcconversion.stc
		even
a23		incbin	amifuture.stc
		even
a24		incbin	whatnext.stc
		even
a25		incbin	wherestheend.stc
		even
a26		incbin	gamedev.stc
		even
a27		incbin	d6-inf-ozartist.stc
		even
a28		incbin	ozscene.stc
		even
a29		incbin	powerup.stc
		even
a30		incbin	osloading.stc
		even
a31		incbin	ppc_assembly.stc
		even
a32		incbin	interview-to-vega.stc
		even
a32a		incbin	d6-interview-randy_rj.stc
		even
a33		incbin	answerphone_1.stc
		even
a34		incbin	answerphone_2.stc
		even	
a35		incbin	biocorp.stc
		even	
a36		incbin	d6-starwreck.stc
		even	
a37		incbin	defy6-t1.stc
		even	
a38		incbin	dfy-eclec01.stc
		even	
a39		incbin	galaxy.stc
		even	
a39b		incbin	thew.c.andthepastor.stc
		even
a39a		incbin	jammin.stc
		even
a40		incbin	manga2.stc
		even	
a41		incbin	plaid.stc
		even	
a42		incbin	rephlex.stc
		even	
a43		incbin	murphy.stc
		even	
a44		incbin	skaters_corner.stc
		even	
a45		incbin	slogans.stc
		even	
a46		incbin	slogans2.stc
		even
a47		incbin	tvreview.stc
		even	
a48		incbin	video_virus.stc
		even
a49		incbin	amiga_domain.stc
		even	
a50		incbin	rezults.stc
		even
a51		incbin	sat96.results.stc
		even	
a52		incbin	tresspass.stc
		even
a53		incbin	coven96.stc
		even	
a54		incbin	usx-dead.stc
		even
a55		incbin	news.stc
		even	
a56		incbin	ads.stc
...
; put path names, 0 terminated, instead of incbins
		...
		incdir	work:cdn/defy6/clips/
pic1		incbin	bubblegum.clip.raw.stc
		even
pic2		incbin	d6swirl.clip.raw.stc
		even
pic3		incbin	defydisk-astral.raw.stc
		even
pic4		incbin	drew1.clip.raw.stc
		even
pic5		incbin	fight.clip.raw.stc
		even
pic6		incbin	fucku.clip.raw.stc
		even
pic7		incbin	hi.clip.raw.stc
		even
pic8		incbin	kimw.clip.raw.stc
		even
pic9		incbin	letzbefriendsclip.raw.stc
		even
pic10		incbin	pain.clip.raw.stc
		even
pic11		incbin	sad.clip.raw.stc
		even
pic12		incbin	souri_clip4.model.raw.stc
		even
pic13		incbin	menu1.raw.stc
		even
pic14		incbin	menu2.raw.stc
		even
pic15		;incbin	menu2.raw.stc
		even

fontpal		dc.w	$000,$aac,$484,$66a,$ccc,$bbb,$aaa,$999
hc2		dc.w	$888,$777,$666,$555,$444,$333,$222,$111
basepal		dc.w	$000,$aac,$484,$66a,$ccc,$bbb,$aaa,$999
...
; can I insert another set of colours in here for the palette?

textcol		dc.w	color00,1,color01,1,color02,1,color03,1,color04,1
		dc.w	color05,1,color06,1,color07,1
highcol		dc.w	color08,$000,color09,$000,color10,$000
		dc.w	color11,$000,color12,$000,color13,$000
		dc.w	color14,$000,color15,$000
...
botbpl		dc.w	bpl1pth,0,bpl1ptl,0
	...
	ifeq	music_on
		...
		incdir	work:cdn/defy6/music/
mod1		incbin	p60.nk-cro-my-friend-2
		even
mod2		incbin	p60.defy_groove
	endc
		even
