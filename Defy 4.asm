...
*******************************************************************************
first		jmp	startup
		dc.b	' - DEFY Issue #3 - ©1995 CYDoNiA - '
		even 
...
write_header
		...
		lea	top+32+(320/8)+(5*80),a1	; this screen
titleloop		
		lea	font2,a4
		moveq	#0,d0
		move.b	(a0)+,d0
...
set_defy_title
	...
	endc
		...
		movem.l	blank3,d0-d7
		movem.l	d0-d7,source_pal
		movem.l	d0-d7,source_pal+16
		movem.l	text_screen-16,d0-d7
		movem.l	d0-d7,dest_pal+16
		move.w	#16,d0
		move.w	#4,d1
		lea	source_pal,a0
		lea	dest_pal,a1
...
write_music
		...
		move.w	#20-1,d6	; this many chars		
		lea	bottom+32+(394/8)+(8*80),a1	; this screen
mus_loop		
		lea	font2,a4
		moveq	#0,d0
		move.b	(a0)+,d0
...
no_music_text	dc.b	'Mod not playing     '
		even
modname1	dc.b	'Images by Earthling '
		even
modname2	dc.b	'Merse Net by Serkul '
		even

clear_music
		lea	bottom+32+(384/8)+(8*80),a1	; this screen
		lea	clips+(384/8)+(38*80),a2
...
; draw eyes
		...
		bne.s	.exit
		move.w	#45,min_y		; index, so new min_y
...
playback_speed	=	3
		...
		incdir 	work:cdn/defy4/music/
		include	player.s
		incdir	work:cdn/defy4/
	endc
...
text
defylogo	incbin	gfx/defy4-title.raw.stc
...
articles
		...
		dc.l	a28
		dc.l	a29,a30,a31,a32,a32a,a33,a34,a35,extr1,a36,a37,a38
		dc.l	a39,a40,extr2,a41,a42,a43,a44
		dc.l	a45,a46,a47,a48,a49,a50,a51,a52,a53,a54,a55
		dc.l	extr3,a56,a57
		dc.l	a59,a60,a61,a62,a63,a63,a63
		dc.l	0,0

		incdir	work:cdn/defy4/art2/
		
aa		incbin	menu.stc
		even
aa1		incbin	editorial.stc
		even
aa2		incbin	contributors.stc
		even	; start FUN here
aa3		incbin	12daysxmas.stc
		even
aa4		incbin	85reasons.stc
		even
aa5		incbin	125-pickups.stc
		even
aa6		incbin	alienbreed3d.stc
		even
aa7		incbin	bartsdetentionlines.stc
		even
a8		incbin	bathroom.stc
		even
a9		incbin	dyt.stc
		even
a10		incbin	earthling2.stc
		even
a11		incbin	elevator.stc
		even
a12		incbin	ibm_apptitude_test.stc
		even
a13		incbin	insurence-forms.stc
		even
a14		incbin	roswell_top_10.stc
		even
a15		incbin	startrek-46.stc
		even
a16		incbin	topten.stc
		even	; start SCENE here
a17		incbin	Amiga-forever.stc
		even
a18		incbin	billacar.stc
		even
a19		incbin	cdn-aga.stc
		even
a20		incbin	convertingaga.stc	
		even
a21		incbin	cougarshiddenpicture.stc
		even
a22		incbin	davehaynie.stc
		even
a23		incbin	escom-tv.stc
		even
a24		incbin	lameandproud?.stc
		even
a25		incbin	lamers.stc
		even
a26		incbin	ozscener.stc
		even
a27		incbin	raytracer.stc
		even
a28		incbin	replytokimba.stc
		even
a29		incbin	trespass.stc
		even
a30		incbin	spanish.scene.stc
		even
a31		incbin	the_spanish_swappers.stc
		even
a32		incbin	project_.stc
		even
a32a		incbin	posadas.report.stc
		even
a33		incbin	euskaliiireporteng.stc
		even
a34		incbin	euskaliiiresulteng.stc
		even	; start reviews here
a35		incbin	7.stc
		even
extr1		incbin	ae_anvil-vapre.stc
		even
a36		incbin	cd_roundup.stc
		even
a37		incbin	pump.stc
		even
a38		incbin	ziq_salsa.stc
		even
a39		incbin	dfbv1.2.stc
		even	; start OTHER here
a40		incbin	486vs040.stc
		even
extr2		incbin	dfy4goth.stc
		even
a41		incbin	ego.stc
		even
a42		incbin	manga.stc
		even
a43		incbin	petro-speech.stc
		even
a44		incbin	theamazingsumeriansfinal.stc
		even
a45		incbin	theexectionerarticle.stc
		even	; start INTERVIEWS here
a46		incbin	accolyte.stc
		even
a47		incbin	bigmac.stc
		even
a48		incbin	cro.stc
		even
a49		incbin	skl_int.stc
		even
a50		incbin	snykers.stc
		even
a51		incbin	storm.stc
		even
a52		incbin	zenith.stc
		even
a53		incbin	ziggy.stc
		even	; start TUTORIALS here
a54		incbin	bezcurve.stc
		even
a55		incbin	zoomrotation.stc
		even
extr3		incbin	skate_intro.stc
		even
a56		incbin	ollie.stc
		even
a57		incbin	nollie.stc
		even
a58		incbin	no_comply.stc
		even
a59		incbin	tricks.stc
		even
a60		incbin	ads.stc
		even
a61		incbin	bbsads.stc
		even
a62		incbin	news.stc
		even
a63		incbin	theend.stc
		even
...
pix		dc.l	pic1,pic2,pic3,pic4,pic5,pic6,pic7,pic8,pic9
		...
		dc.l	pic17,pic18,pic19,pic20,pic21,pic22,pic23
		dc.l	pic24,pic25,pic26,pic27,pic28,pic29,pic30,pic31
		dc.l	0

		incdir	work:cdn/defy4/clips/
pic1		;incbin	1ftollie.raw.stc
		even
pic2		incbin	amiga.raw.stc
		even
pic3		incbin	bezclip1.raw.stc
		even
pic4		incbin	bezclip2.raw.stc
		even
pic5		incbin	bezclip2.raw.stc
		even
pic6		;incbin	bezclip4.raw.stc
		even
pic7		incbin	liquidillusions.raw.stc
		even
pic8		incbin	cydn1.raw.stc
		even
pic9		incbin	cydn2.raw.stc
		even
pic10		incbin	aladdin.raw.stc
		even
pic11		incbin	morethan.raw.stc
		even
pic12		incbin	dfy4-u.o2.raw.stc
		even
pic13		incbin	dreamgirl.raw.stc
		even
pic14		incbin	elle.raw.stc
		even
pic15		incbin	joannea.raw.stc
		even
pic16		incbin	noresemblance.raw.stc
		even
pic17		;incbin	kinkysex.raw.stc
		even
pic18		incbin	lostlove.raw.stc
		even
pic19		incbin	lovers.raw.stc
		even
pic20		incbin	moonchile2.raw.stc
		even
pic21		incbin	nocomply_small.raw.stc
		even
pic22		incbin	nolli.raw.stc
		even
pic23		incbin	sex.raw.stc
		even
pic24		incbin	u-ziq.raw.stc
		even
pic25		incbin	whoa.babe2.raw.stc
		even
pic26		incbin	ziq.raw.stc
		even
pic27		incbin	pd-clipart.raw.stc
		even
pic28		incbin	phobia_bbsad.raw.stc
		even
pic29		incbin	menu1a.raw.stc
		even
pic30		incbin	menu2.raw.stc
		even
pic31		incbin	menu3.raw.stc
		even
...
************************ chip data.
		...
		even
top		incbin	gfx/top.panel
		even
bottom		incbin	gfx/bottom.panel
		even
...
botbpl		dc.w	bpl1pth,0,bpl1ptl,0
	...
	ifeq	music_on
		incdir	work:cdn/defy4/music/
mod1		incbin	p60.images.203971f
		even
mod2		incbin	p60.merse_net.c019109
	endc
		even
